...
export const matchManagementNotifications = {
  ...
  friendlyMatchRequestAccepted: (hostName: string, date: string, time: string, venue: string): NotificationPayload => ({
  ...
  friendlyMatchCancelled: (hostName: string, date: string, time: string): NotificationPayload => ({
  ...
  schedulingConflictDetected: (conflictDetails: string): NotificationPayload => ({
  ...
  friendlyMatchDetailsChanged: (date: string, time: string, venue: string): NotificationPayload => ({
  ...
  matchReminder24h: (opponentName: string, date: string, time: string, venue: string): NotificationPayload => ({
  ...
  matchReminder2h: (opponentName: string, time: string, venue: string): NotificationPayload => ({
    type: NOTIFICATION_TYPES.MATCH_REMINDER,
    category: getCategoryForNotificationType(NOTIFICATION_TYPES.MATCH_REMINDER),
