...
export const NOTIFICATION_TYPES = {
  ...
  INACTIVITY_DURING_LEAGUE_SEASON_NO_MATCH:
    "INACTIVITY_DURING_LEAGUE_SEASON_NO_MATCH",
  INACTIVITY_DURING_LEAGUE_SEASON_2_WEEKS:
    "INACTIVITY_DURING_LEAGUE_SEASON_2_WEEKS",

  // Division notifications [Might be needed in the future, Removed for now]
  ...
  DIVISION_REBALANCED: "DIVISION_REBALANCED",
...
export function getCategoryForNotificationType(
  ...
  const categoryMap: Record<string, NotificationCategory> = {
    ...
    // League Lifecycle
    [NOTIFICATION_TYPES.DIVISION_REBALANCED]: "DIVISION",
    ...
    [NOTIFICATION_TYPES.DMR_DECREASED]: 'GENERAL',
