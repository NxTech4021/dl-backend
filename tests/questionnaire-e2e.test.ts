...
describe('Questionnaire End-to-End Tests', () => {
  ...
  describe('Scoring Verification', () => {
    test('should calculate different ratings for different skill levels', async () => {
      // Test beginner answers
      ...
      // Create second test user for advanced rating
      ...
      // Advanced should have significantly higher rating than beginner
      ...
      await prisma.questionnaireResponse.deleteMany({ where: { userId: advancedUser.id } });
